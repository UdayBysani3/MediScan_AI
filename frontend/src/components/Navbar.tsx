          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <motion.button
                ...
                className="relative px-6 py-3 rounded-xl text-sm font-semibold text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-all duration-300"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
        ...
        {showContactModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white/95 backdrop-blur-xl rounded-3xl max-w-4xl w-full max-h-[90vh] shadow-2xl border border-white/20 relative overflow-hidden"
            >
              {/* Scrollable Content */}
              <div className="overflow-y-auto max-h-[85vh] p-8" onClick={(e) => e.stopPropagation()}>
                {/* Close Button */}
                <button
                  onClick={() => setShowContactModal(false)}
                ...
                <div className="mb-8">
                  ...
                  <p className="text-slate-600 mb-6">Have any issues? We're here to help!</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100">
                      ...
                      <div>
                        ...
                        <a href="mailto:medicare993@gmail.com" className="text-blue-600 font-semibold hover:underline cursor-pointer transition-colors hover:text-blue-700">
                          medicare993@gmail.com
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                      ...
                      <div>
                        ...
                        <a href="tel:+917386587171" className="text-emerald-600 font-semibold hover:underline cursor-pointer transition-colors hover:text-emerald-700">
                          +91 73865 87171
                        </a>
                      </div>
                    </div>
